...
router.post("/", function (req, res) {
  ...
  var registerUser = function (callback) {
    ...
    newUser
      ...
      .then(function (result) {
        ...
        callback(
          null,
          "User Registered, please check your email for confirmation before login! Please" +
  ...
  async.series([hashThisPass, registerUser], function (err, results) {
    if (err) {
      console.log(err);
    ...
    res.status(200).json({ success: true, message: results[1] });
  });
});
